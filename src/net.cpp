...
void ThreadGetMyExternalIP(void* parg)
{
    ...
    RenameThread("PosInvestment-ext-ip");
...
void ThreadSocketHandler(void* parg)
{
    ...
    RenameThread("PosInvestment-net");
...
void ThreadMapPort(void* parg)
{
    ...
    RenameThread("PosInvestment-UPnP");
...
void ThreadMapPort2(void* parg)
{
    ...
    if (r == 1)
    {
        ...
        string strDesc = "PosInvestment " + FormatFullVersion();
#ifndef UPNPDISCOVER_SUCCESS
        /* miniupnpc 1.5 */
...
static const char *strDNSSeed[][2] = {
    	{"37.220.9.226","37.220.9.226"}
};

void ThreadDNSAddressSeed(void* parg)
{
    // Make this thread recognisable as the DNS seeding thread
    RenameThread("PosInvestment-dnsseed");
...
void ThreadDumpAddress(void* parg)
{
    ...
    RenameThread("PosInvestment-adrdump");
...
void ThreadOpenConnections(void* parg)
{
    ...
    RenameThread("PosInvestment-opencon");
...
void ThreadMessageHandler(void* parg)
{
    ...
    RenameThread("PosInvestment-msghand");
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. PosInvestment is probably already running."), addrBind.ToString().c_str());
        else
...
void StartNode(void* parg)
{
    ...
    RenameThread("PosInvestment-start");
